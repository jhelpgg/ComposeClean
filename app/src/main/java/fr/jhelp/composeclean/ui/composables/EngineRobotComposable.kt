...
import fr.jhelp.compose.engine.scene.geometry.robot.animation.headNoAnimation
import fr.jhelp.compose.engine.scene.geometry.robot.animation.headYesAnimation
import fr.jhelp.compose.engine.scene.geometry.robot.animation.run
import fr.jhelp.compose.engine.scene.geometry.robot.animation.walk
