package fr.jhelp.android.library.engine.animation.effect
 ...
 *
 * To play the effect use [fr.jhelp.android.library.engine.scene.Scene3D.play] each time the effect needs to be played
 */
